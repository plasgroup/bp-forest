...
template <dpu_id_t NrDPUs>
inline void UPMEMEmulator<NrDPUs>::print_nr_cold_queries_in_last_batch(std::ostream& ostr, dpu_id_t nr_dpus_to_print) const
{
    if (nr_dpus_to_print > 0) {
        for (dpu_id_t idx_dpu = 0; idx_dpu < NrDPUs && idx_dpu < nr_dpus_to_print; idx_dpu++) {
            if (idx_dpu != 0) {
...
template <dpu_id_t NrDPUs>
inline void UPMEMEmulator<NrDPUs>::print_nr_hot_queries_in_last_batch(std::ostream& ostr, dpu_id_t nr_dpus_to_print) const
{
    if (nr_dpus_to_print > 0) {
        for (dpu_id_t idx_dpu = 0; idx_dpu < NrDPUs && idx_dpu < nr_dpus_to_print; idx_dpu++) {
            if (idx_dpu != 0) {
...
template <dpu_id_t NrDPUs>
inline void UPMEMEmulator<NrDPUs>::print_nr_cold_RMQ_delims_in_last_batch(std::ostream& ostr, dpu_id_t nr_dpus_to_print) const
{
    if (nr_dpus_to_print > 0) {
        for (dpu_id_t idx_dpu = 0; idx_dpu < NrDPUs && idx_dpu < nr_dpus_to_print; idx_dpu++) {
            if (idx_dpu != 0) {
...
template <dpu_id_t NrDPUs>
inline void UPMEMEmulator<NrDPUs>::print_nr_hot_RMQ_delims_in_last_batch(std::ostream& ostr, dpu_id_t nr_dpus_to_print) const
{
    if (nr_dpus_to_print > 0) {
        for (dpu_id_t idx_dpu = 0; idx_dpu < NrDPUs && idx_dpu < nr_dpus_to_print; idx_dpu++) {
            if (idx_dpu != 0) {
...
template <dpu_id_t NrDPUs>
inline void UPMEMEmulator<NrDPUs>::print_nr_cold_pairs(std::ostream& ostr, dpu_id_t nr_dpus_to_print) const
{
    if (nr_dpus_to_print > 0) {
        for (dpu_id_t idx_dpu = 0; idx_dpu < NrDPUs && idx_dpu < nr_dpus_to_print; idx_dpu++) {
            if (idx_dpu != 0) {
...
template <dpu_id_t NrDPUs>
inline void UPMEMEmulator<NrDPUs>::print_nr_hot_pairs(std::ostream& ostr, dpu_id_t nr_dpus_to_print) const
{
    if (nr_dpus_to_print > 0) {
        for (dpu_id_t idx_dpu = 0; idx_dpu < NrDPUs && idx_dpu < nr_dpus_to_print; idx_dpu++) {
            if (idx_dpu != 0) {
