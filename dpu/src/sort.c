...
// extern __mram_ptr KVPair request_buffer[MAX_REQ_NUM_IN_A_DPU];
...
//         if (tid == 0u) {
//             memset(&request_buffer[nelems], -1, sizeof(KVPair) * (ext_nelems - nelems));
//         }
...
//                     KVPair t = request_buffer[idx_lhs];
